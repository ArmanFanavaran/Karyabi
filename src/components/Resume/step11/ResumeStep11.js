...
import Style from "./ResumeStep11.module.css"
...
export default function ResumeStep11() {
...
// Modal.setAppElement('#yourAppElement');
    ...
    useEffect(() => {
        if (sp.get("lang") === "en") {
            initializeTitlesWithValue("Resume | Article")
        } else if (sp.get("lang") === "fa") {
            initializeTitlesWithValue("رزومه | مقالات")
        }
        onGetResume();
    ...
    function onSubmitAdd() {
        ...
        if (add) {
            ...
            var config = {
                method: 'post',
                url: generateURL('/Resume/AddArticleInfoSTP10'),
                headers: {
            ...
            var config = {
                method: 'post',
                url: generateURL('/Resume/UpdateArticleInfoSTP10'),
                headers: {
                    'Content-Type': 'application/json'
                },
                data: data
    ...
    const onUpdateOrder = (source, destination) => {
        ...
        var config = {
            method: 'post',
            url: generateURL('/Resume/ChangeArticleInfoOrderSTP10'),
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const onDelete = (id) => {
        ...
        var config = {
            method: 'post',
            url: generateURL('/Resume/RemoveArticleInfoSTP10'),
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const onEdit = (id) => {
        ...
        if (items[index].ReleaseDate !== "0001-01-01T00:00:00" && items[index].ReleaseDate !== null) {
            setDate(moment(items[index].ReleaseDate, 'YYYY-MM-DD'))
        }
    ...
    const setAddSkill = () => {
        ...
        $('#titleEnglish').val('')
        $('#bookMaker').val('')
        $('#bookMakerEnglish').val('')
        $('#webAddress').val('')
        $('#title').val('')
        setEditItems([])
        setDate(moment(today, 'YYYY/M/D'));
        setNewDate(moment(today, 'YYYY/M/D'));
        setRating(0)
        setEndDateStatus(true)
        setAdd(true)
        openModal()
                                        ...
                                        <div className="col-12" id={'form'}>
                                            <div className={'row'}>
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.titlePersian")}</label>
                                                    </div>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.titleEnglish")}</label>
                                                    </div>
                                                    <div className={Style.selectPart + " " +Style.input}>
                                                        <input defaultValue={editItems.TitleEnglish}
                                                               className={'dir-ltr'}
                                                               autoComplete="off"
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.webAddress")}</label>
                                                    </div>
                                                    <div className={Style.selectPart + " " +Style.input}>
                                                        <input defaultValue={editItems.WebAddress} className={'dir-ltr'}
                                                               autoComplete="off"
                                                               id="webAddress" type="text"/>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.releaseDate")}</label>
                                                    </div>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.bookMaker")}</label>
                                                    </div>
                                                    <div className={Style.selectPart + " " +Style.input}>
                                                        <input defaultValue={editItems.BookMaker} className={'dir-rtl'}
                                                               autoComplete="off"
                                                               id="bookMaker" type="text"/>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.bookMakerEnglish")}</label>
                                                    </div>
                                                    <div className={Style.selectPart + " " +Style.input}>
                                                        <input defaultValue={editItems.BookMakerEnglish}
                                                               className={'dir-ltr'}
                                                               autoComplete="off"
                                                               id="bookMakerEnglish" type="text"/>
                                                ...
                                                <div className="col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.completeInfo")}</label>
                                                    </div>
                                                    <div className={Style.selectPart}>
                                                ...
                                                <div className="col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step11.completeInfoEnglish")}</label>
                                                    </div>
                                                    <div className={Style.selectPart}>
                                                ...
                                                <div className={'col-12'}>
                                                    {
                                                        add === true ?
                                                            <button id={'submitAdd'} onClick={onSubmitAdd}
                                                                ...
                                                                {t("resume.step11.submit")}

                                                            </button> :
                                                            <button id={'submitEdit'} onClick={onSubmitAdd}
                                                                    className="btn change-float-reverse my-3 mx-3 btn-success">
                                                                {t("resume.step11.edit")}
                            ...
                            <div className="row">
                                ...
                                <div className="col-12">
                                    <button onClick={() => history.push({
                                        pathname: getRoutesItems().resumeStep12.route,
