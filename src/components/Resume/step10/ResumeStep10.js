...
import Style from "./ResumeStep10.module.css"
...
export default function ResumeStep10() {
...
// Modal.setAppElement('#yourAppElement');
    ...
    useEffect(() => {
        if (sp.get("lang") === "en") {
            initializeTitlesWithValue("Resume | Honer")
        } else if (sp.get("lang") === "fa") {
            initializeTitlesWithValue("رزومه | افتخارات")
        }
        onGetResume();
    ...
    function onSubmitAdd() {
        ...
        if (add) {
            ...
            var config = {
                method: 'post',
                url: generateURL('/Resume/AddHonorInfoSTP9'),
                headers: {
            ...
            var config = {
                method: 'post',
                url: generateURL('/Resume/UpdateHonorInfoSTP9'),
                headers: {
                    'Content-Type': 'application/json'
                },
                data: data
    ...
    const onUpdateOrder = (source, destination) => {
        ...
        var config = {
            method: 'post',
            url: generateURL('/Resume/ChangeHonorInfoOrderSTP9'),
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const onDelete = (id) => {
        ...
        var config = {
            method: 'post',
            url: generateURL('/Resume/RemoveHonorInfoSTP9'),
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const onEdit = (id) => {
        ...
        if (items[index].Date !== "0001-01-01T00:00:00" && items[index].Date !== null) {
            setDate(moment(items[index].Date, 'YYYY-MM-DD'))
        }
        ...
        axios(config)
            .then(function (response) {
                ...
                if (response.data.data.honorInfoListJson.length !== 0) {
                    let projectList = JSON.parse(response.data.data.honorInfoListJson)
                    // IsSoftWare
                                        ...
                                        <div className="col-12" id={'form'}>
                                            <div className={'row'}>
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step10.titlePersian")}</label>
                                                    </div>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step10.titleEnglish")}</label>
                                                    </div>
                                                    <div className={Style.selectPart + " " +Style.input}>
                                                ...
                                                <div className="col-md-4 col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor="" className="">{t("resume.step10.date")}</label>
                                                    </div>
                                                ...
                                                <div className="col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step10.completeInfo")}</label>
                                                    </div>
                                                    <div className={Style.selectPart}>
                                                ...
                                                <div className="col-12 py-2 change-dir change-text">
                                                    <div className="col-12">
                                                        <label htmlFor=""
                                                               className="">{t("resume.step10.completeInfoEnglish")}</label>
                                                    </div>
                                                    <div className={Style.selectPart}>
                                                ...
                                                <div className={'col-12'}>
                                                    {
                                                        add === true ?
                                                            <button id={'submitAdd'} onClick={onSubmitAdd}
                                                                ...
                                                                {t("resume.step10.submit")}

                                                            </button> :
                                                            <button id={'submitEdit'} onClick={onSubmitAdd}
                                                                    className="btn change-float-reverse my-3 mx-3 btn-success">
                                                                {t("resume.step10.edit")}
